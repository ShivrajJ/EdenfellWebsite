...
import Img1 from '../images/lore1.jpg';
import Img2 from '../images/lore2.jpg';
import Img3 from '../images/lore3.jpg'

export default function Lore() {
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <motion.div className="content-div">
                <motion.img src={Img1} className="content-img-left"/>
                <motion.div>
                    ...
                    <motion.cite>-Fëanor the Fireforged</motion.cite>
                </motion.div>
            </motion.div>

            <motion.div className="content-div-2">
                <motion.h2>Lore</motion.h2>
                <motion.img src={Img2} className="content-img-mid"/>
                <motion.div>
            ...
            <motion.div className="content-div">
                <motion.img src={Img3} className="content-img-left"/>
                <motion.div>
